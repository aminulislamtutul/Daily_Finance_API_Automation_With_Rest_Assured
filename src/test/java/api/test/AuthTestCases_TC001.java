...
public class AuthTestCases_TC001 extends Routes {
    ...
    public void registerExistingMail() throws IOException {
      ...
      //  Assert.assertEquals(res.statusCode(), 400);
        ...
        Assert.assertTrue(message.contains("User already exists with this email address"), "Expected error message not found. Actual: " + message);
